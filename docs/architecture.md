...
- 实时语音捕获和处理
- 高质量语音识别（基于Whisper或FunASR语音识别模型）
- 低延迟文本输入到活动应用程序
- 热键控制的语音识别激活/停用
- 系统托盘界面和状态指示
- 可切换的语音识别模型
...
5. **ModelManager**：管理Whisper 和 FunASR 模型。
   - 加载和卸载模型
   - 实现模型切换功能
   - 管理模型资源
...
| 语音识别 | FunASR | 高质量语音识别、多语言支持、可选模型大小 |
...
2. **替代模型**：支持替换Whisper为其他语音识别引擎（已实现FunASR支持）
